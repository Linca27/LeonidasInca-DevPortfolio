 ...
 * @author Usuario
 */
public class frmIngreso_Producto extends javax.swing.JDialog {

    /**
     * Creates new form frmIngreso_Producto
     */
    public frmIngreso_Producto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public Productos CrearObjeto()
    {
        ...
        Productos ot= new Productos(codigo, nombre, precio);
        return ot;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmIngreso_Producto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmIngreso_Producto dialog = new frmIngreso_Producto(new javax.swing.JFrame(), true);
