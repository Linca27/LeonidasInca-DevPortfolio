 ...
 * @author Usuario
 */
public class frmIngreso_Registrostv extends javax.swing.JDialog {

    /**
     * Creates new form frmIngrese_Registrotv
     */
    public frmIngreso_Registrostv(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Datos de registro Tv");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmIngreso_Registrostv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmIngreso_Registrostv dialog = new frmIngreso_Registrostv(new javax.swing.JFrame(), true);
