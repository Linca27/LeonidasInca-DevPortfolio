 ...
 * @author Usuario
 */
public class frmIngreso_Ventas extends javax.swing.JDialog {

    /**
     * Creates new form fmrIngreso_Ventas
     */
    public frmIngreso_Ventas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
   ...
   public void SetDatos(Ventas nn)
    {
        jTextField1.setText(String.valueOf(nn.getCodigo()));
        jTextField2.setText(String.valueOf(nn.getCedula()));
        jTextField3.setText(String.valueOf(nn.getNombre()));
        jTextField4.setText(String.valueOf(nn.getCelular()));
        jTextField5.setText(String.valueOf(nn.getDireccion()));
        jTextField6.setText(String.valueOf(nn.getFecha()));
        jTextField8.setText(String.valueOf(nn.getProducto()));
    ...
    public Ventas CrearObjeto()
    {
        ...
        Ventas ot= new Ventas(codigo, cedula, nombre, celular, direccion, fecha, producto, total);
        return ot;
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        frmElegir_Producto pn =new frmElegir_Producto(null,true);
        pn.setVisible(true);
        jTextField8.setText(String.valueOf(pn.producto));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmIngreso_Ventas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmIngreso_Ventas dialog = new frmIngreso_Ventas(new javax.swing.JFrame(), true);
