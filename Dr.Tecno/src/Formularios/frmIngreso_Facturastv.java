 ...
 * @author Usuario
 */
public class frmIngreso_Facturastv extends javax.swing.JDialog {

    /**
     * Creates new form frmIngreso_Facturatv
     */
    public frmIngreso_Facturastv(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro Cliente Tv");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        frmElegir_registrostv pn =new frmElegir_registrostv(null,true);
        pn.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmIngreso_Facturastv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmIngreso_Facturastv dialog = new frmIngreso_Facturastv(new javax.swing.JFrame(), true);
