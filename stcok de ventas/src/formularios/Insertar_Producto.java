 ...
 * @author Usuario
 */
public class Insertar_Producto extends javax.swing.JDialog {

    /**
     * Creates new form Insertar_Factura
     */
    public Insertar_Producto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
public Producto CrearObjeto()
    {
        ...
        int cantidad = Integer.valueOf(jTextField3.getText());
        int precio = Integer.valueOf(jTextField4.getText());
        
        Producto ot= new Producto(codigo, producto, cantidad, precio);
        return ot;
    }
    
    public void SetDatos(Producto nn)
    {
        jTextField1.setText(String.valueOf(nn.getCodigo()));
        jTextField2.setText(nn.getProducto());
        jTextField3.setText(String.valueOf(nn.getCantidad()));
        jTextField4.setText(String.valueOf(nn.getPrecio()));
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Insertar_Producto dialog = new Insertar_Producto(new javax.swing.JFrame(), true);
